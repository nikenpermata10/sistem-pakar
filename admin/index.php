		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li><a href="?m=penyakit"></span> Data Penyakit</a></li>
					<li><a href="?m=gejala"></span> Data Gejala</a></li>
					<li><a href="?m=aturan"></span> Basis Aturan</a></li>
					<li><a href="?m=riwayat"></span> Data Riwayat Pasien</a></li>
					<li><a href="aksi.php?act=logout"></span> Logout</a></li>
				</ul>
			</div>
		</div>
	</nav>
